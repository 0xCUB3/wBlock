...
class FilterListLoader {
    ...
    private func createDefaultFilterLists() -> [FilterList] {
        ...
        filterLists.append(contentsOf: [
            ...
            FilterList(id: UUID(), name: "AdGuard Chinese filter", url: URL(string: "https://filters.adtidy.org/extension/chromium/filters/224.txt")!, category: .foreign, description: "EasyList China + AdGuard Chinese filter. Filter list that specifically removes ads on websites in Chinese language.", languages: ["zh"], trustLevel: "full"),
            FilterList(id: UUID(), name: "AdGuard Dutch filter", url: URL(string: "https://filters.adtidy.org/extension/chromium/filters/8.txt")!, category: .foreign, description: "EasyList Dutch + AdGuard Dutch filter. Filter list that specifically removes ads on websites in Dutch language.", languages: ["nl"], trustLevel: "full"),
            FilterList(id: UUID(), name: "AdGuard French filter", url: URL(string: "https://filters.adtidy.org/extension/chromium/filters/16.txt")!, category: .foreign, description: "Liste FR + AdGuard French filter. Filter list that specifically removes ads on websites in French language.", languages: ["fr"], trustLevel: "full"),
            FilterList(id: UUID(), name: "AdGuard German filter", url: URL(string: "https://filters.adtidy.org/extension/chromium/filters/6.txt")!, category: .foreign, description: "EasyList Germany + AdGuard German filter. Filter list that specifically removes ads on websites in German language.", languages: ["de"], trustLevel: "full"),
            FilterList(id: UUID(), name: "AdGuard Japanese filter", url: URL(string: "https://filters.adtidy.org/extension/chromium/filters/7.txt")!, category: .foreign, description: "Filter that enables ad blocking on websites in Japanese language.", languages: ["ja"], trustLevel: "full"),
            FilterList(id: UUID(), name: "AdGuard Russian filter", url: URL(string: "https://filters.adtidy.org/extension/chromium/filters/1.txt")!, category: .foreign, description: "Filter that enables ad blocking on websites in Russian language.", languages: ["ru"], trustLevel: "full"),
            FilterList(id: UUID(), name: "AdGuard Spanish/Portuguese filter", url: URL(string: "https://filters.adtidy.org/extension/chromium/filters/9.txt")!, category: .foreign, description: "Filter list that specifically removes ads on websites in Spanish, Portuguese, and Brazilian Portuguese languages.", languages: ["es", "pt"], trustLevel: "full"),
            FilterList(id: UUID(), name: "AdGuard Turkish filter", url: URL(string: "https://filters.adtidy.org/extension/chromium/filters/13.txt")!, category: .foreign, description: "Filter list that specifically removes ads on websites in Turkish language.", languages: ["tr"], trustLevel: "full"),
            FilterList(id: UUID(), name: "AdGuard Ukrainian filter", url: URL(string: "https://filters.adtidy.org/extension/chromium/filters/23.txt")!, category: .foreign, description: "Filter that enables ad blocking on websites in Ukrainian language.", languages: ["uk"], trustLevel: "full"),
