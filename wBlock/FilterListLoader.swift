...
class FilterListLoader {
    ...
    private func createDefaultFilterLists() -> [FilterList] {
        ...
        filterLists.append(contentsOf: [
            FilterList(id: UUID(), name: "ABPindo", url: URL(string: "https://raw.githubusercontent.com/ABPindo/indonesianadblockrules/master/subscriptions/abpindo.txt")!, category: .foreign, description: "Additional filter list for websites in Indonesian.", languages: ["id"], trustLevel: "high"),
            FilterList(id: UUID(), name: "ABPVN List", url: URL(string: "https://raw.githubusercontent.com/abpvn/abpvn/master/filter/abpvn_adguard.txt")!, category: .foreign, description: "Vietnamese adblock filter list.", languages: ["vi"], trustLevel: "high"),
            FilterList(id: UUID(), name: "Adblock List for Finland", url: URL(string: "https://raw.githubusercontent.com/finnish-easylist-addition/finnish-easylist-addition/gh-pages/Finland_adb.txt")!, category: .foreign, description: "Finnish ad blocking filter list.", languages: ["fi"], trustLevel: "high"),
            FilterList(id: UUID(), name: "AdBlockID", url: URL(string: "https://raw.githubusercontent.com/realodix/AdBlockID/main/dist/adblockid.adfl.txt")!, category: .foreign, description: "Additional filter list for websites in Indonesian.", languages: ["id"], trustLevel: "high"),
            FilterList(id: UUID(), name: "AdGuard Chinese filter", url: URL(string: "https://raw.githubusercontent.com/AdguardTeam/FiltersRegistry/refs/heads/master/platforms/extension/safari/filters/224_optimized.txt")!, category: .foreign, description: "EasyList China + AdGuard Chinese filter. Filter list that specifically removes ads on websites in Chinese language.", languages: ["zh"], trustLevel: "full"),
            FilterList(id: UUID(), name: "AdGuard Dutch filter", url: URL(string: "https://raw.githubusercontent.com/AdguardTeam/FiltersRegistry/refs/heads/master/platforms/extension/safari/filters/8_optimized.txt")!, category: .foreign, description: "EasyList Dutch + AdGuard Dutch filter. Filter list that specifically removes ads on websites in Dutch language.", languages: ["nl"], trustLevel: "full"),
            FilterList(id: UUID(), name: "AdGuard French filter", url: URL(string: "https://raw.githubusercontent.com/AdguardTeam/FiltersRegistry/refs/heads/master/platforms/extension/safari/filters/16_optimized.txt")!, category: .foreign, description: "Liste FR + AdGuard French filter. Filter list that specifically removes ads on websites in French language.", languages: ["fr"], trustLevel: "full"),
            FilterList(id: UUID(), name: "AdGuard German filter", url: URL(string: "https://raw.githubusercontent.com/AdguardTeam/FiltersRegistry/refs/heads/master/platforms/extension/safari/filters/6_optimized.txt")!, category: .foreign, description: "EasyList Germany + AdGuard German filter. Filter list that specifically removes ads on websites in German language.", languages: ["de"], trustLevel: "full"),
            FilterList(id: UUID(), name: "AdGuard Japanese filter", url: URL(string: "https://raw.githubusercontent.com/AdguardTeam/FiltersRegistry/refs/heads/master/platforms/extension/safari/filters/7_optimized.txt")!, category: .foreign, description: "Filter that enables ad blocking on websites in Japanese language.", languages: ["ja"], trustLevel: "full"),
            FilterList(id: UUID(), name: "AdGuard Russian filter", url: URL(string: "https://raw.githubusercontent.com/AdguardTeam/FiltersRegistry/refs/heads/master/platforms/extension/safari/filters/1_optimized.txt")!, category: .foreign, description: "Filter that enables ad blocking on websites in Russian language.", languages: ["ru"], trustLevel: "full"),
            FilterList(id: UUID(), name: "AdGuard Spanish/Portuguese filter", url: URL(string: "https://raw.githubusercontent.com/AdguardTeam/FiltersRegistry/refs/heads/master/platforms/extension/safari/filters/9_optimized.txt")!, category: .foreign, description: "Filter list that specifically removes ads on websites in Spanish, Portuguese, and Brazilian Portuguese languages.", languages: ["es", "pt"], trustLevel: "full"),
            FilterList(id: UUID(), name: "AdGuard Turkish filter", url: URL(string: "https://raw.githubusercontent.com/AdguardTeam/FiltersRegistry/refs/heads/master/platforms/extension/safari/filters/13_optimized.txt")!, category: .foreign, description: "Filter list that specifically removes ads on websites in Turkish language.", languages: ["tr"], trustLevel: "full"),
            FilterList(id: UUID(), name: "AdGuard Ukrainian filter", url: URL(string: "https://raw.githubusercontent.com/AdguardTeam/FiltersRegistry/refs/heads/master/platforms/extension/safari/filters/23_optimized.txt")!, category: .foreign, description: "Filter that enables ad blocking on websites in Ukrainian language.", languages: ["uk"], trustLevel: "full"),
            FilterList(id: UUID(), name: "Bulgarian list", url: URL(string: "https://stanev.org/abp/adblock_bg.txt")!, category: .foreign, description: "Additional filter list for websites in Bulgarian.", languages: ["bg"], trustLevel: "high"),
            FilterList(id: UUID(), name: "CJX's Annoyances List", url: URL(string: "https://raw.githubusercontent.com/cjx82630/cjxlist/master/cjx-annoyance.txt")!, category: .foreign, description: "Supplement for EasyList China+EasyList and EasyPrivacy.", languages: ["zh"], trustLevel: "low"),
            FilterList(id: UUID(), name: "Dandelion Sprout's Nordic Filters", url: URL(string: "https://raw.githubusercontent.com/DandelionSprout/adfilt/master/NorwegianExperimentalList%20alternate%20versions/NordicFiltersAdGuard.txt")!, category: .foreign, description: "This list covers websites for Norway, Denmark, Iceland, Danish territories, and the Sami indigenous population.", languages: ["no", "da", "is", "fo"], trustLevel: "high"),
            FilterList(id: UUID(), name: "Dandelion Sprout's Serbo-Croatian List", url: URL(string: "https://raw.githubusercontent.com/DandelionSprout/adfilt/master/SerboCroatianList.txt")!, category: .foreign, description: "A filter list for websites in Serbian, Montenegrin, Croatian, and Bosnian.", languages: ["sr", "hr"], trustLevel: "high"),
            FilterList(id: UUID(), name: "EasyList China", url: URL(string: "https://raw.githubusercontent.com/easylist/easylistchina/master/easylistchina.txt")!, category: .foreign, description: "Additional filter list for websites in Chinese. Already included in AdGuard Chinese filter.", languages: ["zh"], trustLevel: "high"),
            FilterList(id: UUID(), name: "EasyList Czech and Slovak", url: URL(string: "https://raw.githubusercontent.com/tomasko126/easylistczechandslovak/master/filters.txt")!, category: .foreign, description: "Additional filter list for websites in Czech and Slovak.", languages: ["cs", "sk"], trustLevel: "high"),
            FilterList(id: UUID(), name: "EasyList Dutch", url: URL(string: "https://easylist-downloads.adblockplus.org/easylistdutch.txt")!, category: .foreign, description: "Additional filter list for websites in Dutch. Already included in AdGuard Dutch filter.", languages: ["nl"], trustLevel: "low"),
            FilterList(id: UUID(), name: "EasyList Germany", url: URL(string: "https://easylist.to/easylistgermany/easylistgermany.txt")!, category: .foreign, description: "Additional filter list for websites in German. Already included in AdGuard German filter.", languages: ["de"], trustLevel: "low"),
            FilterList(id: UUID(), name: "EasyList Hebrew", url: URL(string: "https://raw.githubusercontent.com/easylist/EasyListHebrew/master/EasyListHebrew.txt")!, category: .foreign, description: "Additional filter list for websites in Hebrew.", languages: ["he"], trustLevel: "high"),
            FilterList(id: UUID(), name: "EasyList Italy", url: URL(string: "https://easylist-downloads.adblockplus.org/easylistitaly.txt")!, category: .foreign, description: "Additional filter list for websites in Italian.", languages: ["it"], trustLevel: "high"),
            FilterList(id: UUID(), name: "EasyList Lithuania", url: URL(string: "https://raw.githubusercontent.com/EasyList-Lithuania/easylist_lithuania/master/easylistlithuania.txt")!, category: .foreign, description: "Additional filter list for websites in Lithuanian.", languages: ["lt"], trustLevel: "high"),
            FilterList(id: UUID(), name: "EasyList Polish", url: URL(string: "https://easylist-downloads.adblockplus.org/easylistpolish.txt")!, category: .foreign, description: "Additional filter list for websites in Polish.", languages: ["pl"], trustLevel: "low"),
            FilterList(id: UUID(), name: "EasyList Portuguese", url: URL(string: "https://easylist-downloads.adblockplus.org/easylistportuguese.txt")!, category: .foreign, description: "Additional filter list for websites in Spanish and Portuguese.", languages: ["es", "pt"], trustLevel: "low"),
            FilterList(id: UUID(), name: "EasyList Spanish", url: URL(string: "https://easylist-downloads.adblockplus.org/easylistspanish.txt")!, category: .foreign, description: "Additional filter list for websites in Spanish.", languages: ["es"], trustLevel: "low"),
            FilterList(id: UUID(), name: "EasyList Thailand", url: URL(string: "https://raw.githubusercontent.com/easylist-thailand/easylist-thailand/master/subscription/easylist-thailand.txt")!, category: .foreign, description: "Filter that blocks ads on Thai sites.", languages: ["th"], trustLevel: "high"),
            FilterList(id: UUID(), name: "Estonian List", url: URL(string: "https://adblock.ee/list.txt")!, category: .foreign, description: "Filter for ad blocking on Estonian sites.", languages: ["et"], trustLevel: "low"),
            FilterList(id: UUID(), name: "Frellwit's Swedish Filter", url: URL(string: "https://raw.githubusercontent.com/lassekongo83/Frellwits-filter-lists/master/Frellwits-Swedish-Filter.txt")!, category: .foreign, description: "Filter that aims to remove regional Swedish ads, tracking, social media, annoyances, sponsored articles etc.", languages: ["sv"], trustLevel: "high"),
            FilterList(id: UUID(), name: "Greek AdBlock Filter", url: URL(string: "https://www.void.gr/kargig/void-gr-filters.txt")!, category: .foreign, description: "Additional filter list for websites in Greek.", languages: ["el"], trustLevel: "low"),
            FilterList(id: UUID(), name: "Hungarian filter", url: URL(string: "https://cdn.jsdelivr.net/gh/hufilter/hufilter@gh-pages/hufilter-adguard.txt")!, category: .foreign, description: "Hufilter. Filter list that specifically removes ads on websites in the Hungarian language.", languages: ["hu"], trustLevel: "high"),
            FilterList(id: UUID(), name: "Icelandic ABP List", url: URL(string: "https://adblock.gardar.net/is.abp.txt")!, category: .foreign, description: "Additional filter list for websites in Icelandic.", languages: ["is"], trustLevel: "high"),
            ...
            FilterList(id: UUID(), name: "Official Polish filters for AdBlock, uBlock Origin & AdGuard", url: URL(string: "https://raw.githubusercontent.com/MajkiIT/polish-ads-filter/master/polish-adblock-filters/adblock.txt")!, category: .foreign, description: "Additional filter list for websites in Polish.", languages: ["pl"], trustLevel: "high"),
            FilterList(id: UUID(), name: "Persian Blocker", url: URL(string: "https://raw.githubusercontent.com/MasterKia/PersianBlocker/main/PersianBlocker.txt")!, category: .foreign, description: "Filter list for blocking ads and trackers on websites in Persian.", languages: ["fa", "tg", "ps"], trustLevel: "high"),
            FilterList(id: UUID(), name: "Polish Annoyances Filters", url: URL(string: "https://raw.githubusercontent.com/PolishFiltersTeam/PolishAnnoyanceFilters/master/PPB.txt")!, category: .foreign, description: "Filter list that hides and blocks pop-ups, widgets, newsletters, push notifications, arrows, tagged internal links that are off-topic, and other irritating elements. Polish GDPR-Cookies Filters is already in it.", languages: ["pl"], trustLevel: "high"),
            FilterList(id: UUID(), name: "Polish Anti Adblock Filters", url: URL(string: "https://raw.githubusercontent.com/olegwukr/polish-privacy-filters/master/anti-adblock.txt")!, category: .foreign, description: "Official Polish filters against Adblock alerts.", languages: ["pl"], trustLevel: "high"),
            FilterList(id: UUID(), name: "Polish Anti-Annoying Special Supplement", url: URL(string: "https://raw.githubusercontent.com/FiltersHeroes/PolishAntiAnnoyingSpecialSupplement/master/polish_rss_filters.txt")!, category: .foreign, description: "Filters that block and hide RSS elements and remnants of hidden newsletters combined with social elements on Polish websites.", languages: ["pl"], trustLevel: "high"),
            FilterList(id: UUID(), name: "Polish GDPR-Cookies Filters", url: URL(string: "https://raw.githubusercontent.com/MajkiIT/polish-ads-filter/master/cookies_filters/adblock_cookies.txt")!, category: .foreign, description: "Polish filter list for cookies blocking.", languages: ["pl"], trustLevel: "high"),
            FilterList(id: UUID(), name: "Polish Social Filters", url: URL(string: "https://raw.githubusercontent.com/MajkiIT/polish-ads-filter/master/adblock_social_filters/adblock_social_list.txt")!, category: .foreign, description: "Polish filter list for social widgets, popups, etc.", languages: ["pl"], trustLevel: "high"),
            FilterList(id: UUID(), name: "road-block light", url: URL(string: "https://raw.githubusercontent.com/tcptomato/ROad-Block/master/road-block-filters-light.txt")!, category: .foreign, description: "Romanian ad blocking filter subscription.", languages: ["ro"], trustLevel: "high"),
            FilterList(id: UUID(), name: "ROList", url: URL(string: "https://www.zoso.ro/pages/rolist.txt")!, category: .foreign, description: "Additional filter list for websites in Romanian.", languages: ["ro"], trustLevel: "low"),
            FilterList(id: UUID(), name: "ROLIST2", url: URL(string: "https://www.zoso.ro/pages/rolist2.txt")!, category: .foreign, description: "This is a complementary list for ROList with annoyances that are not necessarily banners. It is a very aggressive list and not recommended for beginners.", languages: ["ro"], trustLevel: "low"),
            FilterList(id: UUID(), name: "RU AdList: Counters", url: URL(string: "https://easylist-downloads.adblockplus.org/cntblock.txt")!, category: .foreign, description: "RU AdList supplement for trackers blocking.", languages: ["ru"], trustLevel: "low"),
