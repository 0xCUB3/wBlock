...
(function () {
  ...
  function GoogleAnalytics(source, args) {
    ...
    function GoogleAnalytics(source) {
      ...
      var queue =
        (_window$googleAnalyti = window[googleAnalyticsName]) === null ||
        _window$googleAnalyti === void 0
          ? void 0
    ...
    function GoogleIma3(source) {
      ...
      var EventHandler = function EventHandler() {
        ...
        this.removeEventListener = function (types, callback) {
          ...
          for (var i = 0; i < types.length; i += 1) {
            ...
            var type = types[i];
            (_this$listeners$get = this.listeners.get(type)) === null ||
      ...
      var isEngadget = function isEngadget() {
        try {
          for (
            var _i3 = 0,
              _Object$values = Object.values(window.vidible._getContexts());
  ...
  function GoogleTagServicesGpt(source, args) {
    ...
    function GoogleTagServicesGpt(source) {
      ...
      var recreateIframeForSlot = function recreateIframeForSlot(slot) {
        ...
        (_document$getElementB = document.getElementById(eid)) === null ||
    ...
    function hrefSanitizer(source, selector) {
      ...
      var decodeHashString = function decodeHashString(hash) {
        ...
        return validEncodedHash
          ? decodeBase64SeveralTimes(validEncodedHash, DECODE_ATTEMPTS_NUMBER)
          : "";
      };
  ...
  function noProtectedAudience(source, args) {
    ...
    function noProtectedAudience(source) {
      ...
      for (
        var _i = 0, _Object$keys = Object.keys(protectedAudienceMethods);
        _i < _Object$keys.length;
        _i++
      ) {
        var key = _Object$keys[_i];
      ...
      var check = function check(str) {
        ...
        for (var i = 0; i < signatures.length; i += 1) {
          ...
          for (var j = 0; j < tokens.length; j += 1) {
            var token = tokens[j];
            var found =
              token instanceof RegExp ? token.test(str) : str.includes(token);
            if (found) {
              match += 1;
            }
          }
    ...
    function preventRequestAnimationFrame(source, match) {
      ...
      var rafWrapper = function rafWrapper(callback) {
        ...
        if (shouldLog) {
          ...
          shouldPrevent =
            matchRegexp.test(callback.toString()) !== isInvertedMatch;
        }
        if (shouldPrevent) {
          hit(source);
    ...
    function preventXHR(source, propsToMatch, customResponseText) {
      ...
      var sendWrapper = function sendWrapper(target, thisArg, args) {
        ...
        var transitionReadyState = function transitionReadyState(state) {
          if (state === 4) {
            var { responseURL: responseURL, responseXML: responseXML } =
              forgedRequest;
            Object.defineProperties(thisArg, {
              readyState: {
                value: 4,
  ...
  function trustedClickElement(source, args) {
    ...
    function trustedClickElement(source, selectors) {
      var extraMatch =
        arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "";
      var delay =
        arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : NaN;
      var reload =
        arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : "";
      if (!selectors) {
        return;
      ...
      if (delay) {
        ...
        var isValidDelay =
          !Number.isNaN(parsedDelay) || parsedDelay < OBSERVER_TIMEOUT_MS;
        if (!isValidDelay) {
      ...
      if (extraMatch) {
        ...
        parsedExtraMatch.forEach(function (matchStr) {
          if (matchStr.includes(COOKIE_MATCH_MARKER)) {
            var { isInvertedMatch: isInvertedMatch, matchValue: matchValue } =
          ...
          if (matchStr.includes(LOCAL_STORAGE_MATCH_MARKER)) {
            var { isInvertedMatch: _isInvertedMatch, matchValue: _matchValue } =
              parseMatchArg(matchStr);
