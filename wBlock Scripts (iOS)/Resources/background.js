...
/*
 * WebExtension v1.0.4 (build date: Fri, 24 Apr 2026 16:25:58 GMT)
 * (c) 2026 ameshkov
...
(function (browser) {
  ...
  function jsonPrune(source, args) {
    ...
    function jsonPath(e, r, t, a, n) {
      ...
      function appendPath(e, r) {
        return "number" == typeof r || /^\d+$/.test(String(r)) ? `${e}[${r}]` : b.test(String(r)) ? `${e}.${r}` : `${e}['${String(r).replace(/'/g, "\\'")}']`;
      }
      ...
      function walkTopLevelChars(e, r) {
        for (var t = 0, a = 0, n = 0, i = null, s = 0; s < e.length; s += 1) {
          ...
          if (i) {
            ...
            var l = true;
            if (o === f ? t += 1 : "]" === o ? t -= 1 : "{" === o ? a += 1 : "}" === o ? a -= 1 : "(" === o ? n += 1 : o === h ? n -= 1 : l = false, r(s, !l && 0 === t && 0 === a && 0 === n)) return;
          }
        }
      }
      function findClosingBracket(e, r) {
        for (var t = 0, a = null, n = r; n < e.length; n += 1) {
          var i = e[n];
          if (a) i !== a || isEscaped(e, n) || (a = null);else if (isQuoteCharacter(i)) a = i;else if (i !== f) {
            if ("]" === i && 0 === (t -= 1)) return n;
          } else t += 1;
        }
        return -1;
      ...
      function normalizeFilterPath(e) {
        var r = e.trim();
        return r.startsWith(v) && (r = r.slice(1)), r === p ? o : r.startsWith(o) ? r : r.startsWith(l) || r.startsWith(u) || r.startsWith(f) ? `${o}${r}` : `${o}${l}${r}`;
      }
      function parseFilterExpression(e) {
        var r = e.trim();
        if (r.startsWith("(") && r.endsWith(h)) {
          for (var t = 0, a = null, n = false, i = 0; i < r.length; i += 1) {
            var s = r[i];
            if (a) s !== a || isEscaped(r, i) || (a = null);else if (isQuoteCharacter(s)) a = s;else if ("(" === s) t += 1;else if (s === h && 0 === (t -= 1)) {
              n = i === r.length - 1;
              break;
            }
          }
        ...
        var c,
          b,
          w = (b = null, walkTopLevelChars(c = r, function (e, r) {
            if (!r) return false;
            for (var t = null, a = 0; a < C.length; a += 1) {
              var n = C[a];
        ...
        var W = r.slice(0, w.index).trim(),
          A = r.slice(w.index + w.operator.length).trim(),
          E = g;
        "!=" === w.operator ? E = S : "<" === w.operator ? E = k : "<=" === w.operator ? E = x : ">" === w.operator ? E = y : ">=" === w.operator ? E = P : "*=" === w.operator ? E = d : ("=~" === w.operator || "=" === w.operator && /^\/.*\/[a-z]*$/i.test(A)) && (E = $);
        var O,
          j,
          F = A.trim(),
          L = F === o || F.startsWith(o + l) || F.startsWith(o + f),
          M = F === v || F.startsWith(v + l) || F.startsWith(v + f);
        return L || M ? {
          comparisonSelectorPath: normalizeFilterPath(F),
          operator: E,
          resolveComparisonAgainstRoot: L,
          selectorPath: normalizeFilterPath(W)
        } : {
          comparisonValue: (O = A, j = O.trim(), "true" === j || "false" !== j && ("null" === j ? null : /^-?\d+(?:\.\d+)?$/.test(j) ? Number(j) : /^\/.*\/[a-z]*$/i.test(j) ? toRegExp(j) : stripQuotes(j))),
          operator: E,
          selectorPath: normalizeFilterPath(W)
        };
      }
      ...
      function parseJsonPathSelector(e) {
        ...
        for (e.startsWith(o) && (t = 1); t < e.length;) {
          ...
          if (e[t] !== f) {
            if ("*" !== e[t]) {
              for (var n = t; n < e.length && e[n] !== l && e[n] !== f;) n += 1;
      ...
      function buildAppendUpdater(e, r, t) {
        var a,
          n = e.trim();
        if (n.startsWith("{") || n.startsWith(f)) a = r(n);else {
          var i = t(n);
      ...
      function buildSetUpdater(e, r, t) {
        var a = e.trim();
        if (a.startsWith("replace(") && a.endsWith(h)) return function (e, r) {
          var t = r(e.slice(8, -1));
      ...
      function getRecursiveCandidates(e) {
        for (var r = [e], t = getChildCandidates(e), a = 0; a < t.length; a += 1) r.push(t[a]);
        for (var n = 1; n < r.length;) {
          for (var i = getChildCandidates(r[n]), s = 0; s < i.length; s += 1) r.push(i[s]);
          n += 1;
        }
        return r;
      }
      ...
      function applyDirectStep(e, r) {
        ...
        if ("property" === r.mode) {
          ...
          for (var a = new Set(), n = 0; n < r.properties.length; n += 1) {
            ...
            } else !a.has(i) && Object.prototype.hasOwnProperty.call(e.value, i) && (a.add(i), t.push(createCandidate(e.value[i], e.value, i, appendPath(e.path, i))));
          }
          return t;
        }
        ...
        if ("computed-index" === r.mode) {
          ...
          return c >= 0 && c < e.value.length && t.push(createCandidate(e.value[c], e.value, c, appendPath(e.path, c))), t;
        }
        if ("slice" === r.mode) {
          if (!Array.isArray(e.value) || !r.slice) return t;
          for (var h = function (e, r) {
              var t,
                a,
                n = [],
                i = void 0 === r.step ? 1 : r.step;
              if (0 === i) return n;
              if (t = void 0 === r.start ? i > 0 ? 0 : e - 1 : resolveIndex(e, r.start), a = void 0 === r.end ? i > 0 ? e : -1 : resolveIndex(e, r.end), i > 0) {
                for (var s = Math.max(0, t); s < Math.min(e, a); s += i) n.push(s);
                return n;
              }
              for (var o = Math.min(e - 1, t); o > Math.max(-1, a); o += i) n.push(o);
              return n;
            }(e.value.length, r.slice), f = 0; f < h.length; f += 1) {
            var v = h[f];
      ...
      function evaluateSelector(e, t) {
          ...
          for (var s = 0; s < a.length; s += 1) {
            ...
            if (t.operator !== d) {
              if (t.operator !== $) {
                ...
                if (t.operator === x && o <= n) return true;
        ...
        for (var a = [createCandidate(e, null, null, o)], n = 0; n < t.steps.length; n += 1) {
          var i = t.steps[n];
          if ("filter" === i.mode && i.filter) a = applyFilterStep(a, i.filter);else {
            for (var s = [], l = 0; l < a.length; l += 1) for (var u = a[l], p = i.recursive ? getRecursiveCandidates(u) : [u], c = 0; c < p.length; c += 1) for (var h = applyDirectStep(p[c], i), f = 0; f < h.length; f += 1) s.push(h[f]);
            a = s;
          }
        }
        return a;
      ...
      var W,
        A = (W = a) && W.nativeParse ? W.nativeParse : JSON.parse,
        E = function (e) {
          return e && e.nativeStringify ? e.nativeStringify : JSON.stringify;
        }(a),
        O = new Error().stack || "";
      if (i && !matchStackTrace(i, O)) return r;
      if (!t) return logMessage(e, `${window.location.hostname}\n${E(r, null, 2)}\nStack trace:\n${O}`, true), logMessage(e, r, true, false), r;
      try {
        for (var j = function (e, r, t) {
            var a,
              n,
              i = function (e) {
                var r = -1,
                  ...
                  a = 0;
                return walkTopLevelChars(e, function (n, i) {
                  return !!i && (e.startsWith("+=", n) ? (r = n, t = "append", a = 2, !0) : "=" === e[n] && (r = n, t = "set", a = 1, !0));
                }), -1 === r ? {
                  mode: "remove",
                  selectorPart: e.trim(),
                  valuePart: p
              ...
              c = parseJsonPathSelector((a = s.selectorPart, (n = a.trim()) === p ? o : n.startsWith(o) ? n : n.startsWith(l) || n.startsWith(f) || n.startsWith(u) ? `${o}${n}` : `${o}${l}${n}`)),
              h = {
                mode: i.mode
              };
            return "append" === i.mode ? h = {
              mode: "append",
        ...
        var L = evaluateSelector(r, j.selector);
        if (s) return L.length > 0 && n && n(), r;
        if (!("remove" === j.mutation.mode || "string" == typeof e.name && e.name.startsWith("trusted-"))) return logMessage(e, "JSONPath set and append operations are allowed only in trusted scriptlets"), r;
        if ("remove" === j.mutation.mode) return function (e) {
        ...
        j.mutation.updater && (r = function (e, r, t) {
          for (var a = new Set(), n = e, i = 0; i < r.length; i += 1) {
            var s = r[i];
            a.has(s.path) || (a.add(s.path), null !== s.parent || null !== s.key || s.path !== o ? null !== s.parent && null !== s.key && (s.parent[s.key] = t(s.parent[s.key]), markMutated()) : (n = t(n), markMutated()));
          }
          return n;
        }(r, L, j.mutation.updater), w && n && n());
      } catch (r) {
    ...
    function resolveJsonSyntaxMode(t, r) {
      var e = "legacy",
        o = "jsonpath",
        s = "string" == typeof r ? r.trim().toLowerCase() : "";
      if (s === e || s === o) return {
        mode: s
      };
      ...
      if (extraMatch) {
        ...
        parsedExtraMatch.forEach(function (matchStr) {
          ...
          if (matchStr.includes(CLICK_TYPE_MATCH_MARKER)) {
            var {
              isInvertedMatch: _isInvertedMatch2,
              matchValue: _matchValue3
            } = parseMatchArg(matchStr);
    ...
    function clickElement(e) {
      ...
      if (s && "native" !== n) {
        ...
        if (a && "function" == typeof a.onClick) {
          ...
          var v = new MouseEvent("click", c),
            l = createEventProxy(v, "click", true);
      ...
      !function () {
        var n,
          ...
          o,
          i,
          s = "function" == typeof PointerEvent,
          a = new Set(["click", "mousedown", "mouseup", "mouseover", "mouseenter", "pointerdown", "pointerup", "pointerover", "pointerenter"]),
          f = (n = e, t = a, o = new Map(), i = n, t.forEach(function (e) {
            var n = `on${e}`,
              t = i[n];
        ...
        try {
          s && (e.dispatchEvent(new PointerEvent("pointerover", r)), e.dispatchEvent(new PointerEvent("pointerenter", u))), e.dispatchEvent(new MouseEvent("mouseover", r)), e.dispatchEvent(new MouseEvent("mouseenter", u)), s && e.dispatchEvent(new PointerEvent("pointerdown", r)), e.dispatchEvent(new MouseEvent("mousedown", r)), e.focus(), s && e.dispatchEvent(new PointerEvent("pointerup", c)), e.dispatchEvent(new MouseEvent("mouseup", c)), e.dispatchEvent(new MouseEvent("click", c));
        } finally {
          f();
        }
      }();
  ...
  function trustedJsonSet(source, args) {
    ...
    function jsonSetter(e, n, t, r, o, a, i, s, l) {
      var {
        ...
        notifyMutation = function notifyMutation() {
          hit(e), l && l();
        };
      if (!t) return logMessage(e, `${window.location.hostname}\n${c(n, null, 2)}\nStack trace:\n${new Error().stack}`, true), n && "object" == typeof n && logMessage(e, n, true, false), n;
      try {
    ...
    function matchesJsonPath(n, t, o, r) {
      ...
      return jsonPath(n, t, o, r, function () {
        a = !0;
      }, arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : "", true), a;
    }
    function resolveJsonSyntaxMode(t, r) {
      var e = "legacy",
        o = "jsonpath",
  ...
  /*
   * SafariExtension v4.2.2 (build date: Wed, 25 Mar 2026 19:39:46 GMT)
  ...
  class BackgroundScript {
     ...
     */
    constructor() {
      let registeredScripts = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : new Map();
      /**
    ...
    static async runScripts(tabId, frameId, scripts, registeredScripts) {
      if (scripts.length === 0) {
        log$1.debug('No scripts to run in tab', tabId, 'frame', frameId);
        return;
      }
      ...
      log$1.debug('Found', scriptFunctions.length, 'registered functions and', scriptTexts.length, 'scripts to run in tab', tabId, 'frame', frameId);
      ...
      log$1.debug('Finished running scripts in tab', tabId, 'frame', frameId);
    }
    /**
    ...
    static async runScriptFunctions(tabId, frameId, scriptFunctions) {
      if (scriptFunctions.length === 0) {
        log$1.debug('No script functions to run in tab', tabId, 'frame', frameId);
        return;
      }
      log$1.debug('Running script functions in tab', tabId, 'frame', frameId, 'script functions', scriptFunctions);
      ...
      log$1.debug('Finished running script functions in tab', tabId, 'frame', frameId);
    }
    /**
    ...
    static async runScriptFunction(tabId, frameId, scriptFunction) {
      log$1.debug('Running script function in tab', tabId, 'frame', frameId, 'script function', scriptFunction);
      ...
      log$1.debug('Finished running script function in tab', tabId, 'frame', frameId);
    }
    /**
    ...
    static async runScriptTexts(tabId, frameId, scriptTexts) {
      if (scriptTexts.length === 0) {
        log$1.debug('No script texts to run in tab', tabId, 'frame', frameId);
        return;
      }
      log$1.debug('Running script texts in tab', tabId, 'frame', frameId, 'script texts', scriptTexts);
      await BackgroundScript.executeScript({
        target: {
          tabId,
          frameIds: [frameId]
      ...
      log$1.debug('Finished running script texts in tab', tabId, 'frame', frameId);
    }
    /**
    ...
    static async insertExtendedCss(tabId, frameId, extendedCss) {
      if (extendedCss.length === 0) {
        log$1.debug('No extended CSS to insert into tab', tabId, 'frame', frameId);
        return;
      }
      await BackgroundScript.executeScript({
        target: {
    ...
    static async insertCss(tabId, frameId, css) {
      if (css.length === 0) {
        log$1.debug('No CSS to insert into tab', tabId, 'frame', frameId);
        return;
      }
      log$1.debug('Inserting CSS into tab', tabId, 'frame', frameId, 'css', css);
    ...
    static async runScriptlets(tabId, frameId, scriptlets) {
      if (scriptlets.length === 0) {
        log$1.debug('No scriptlets to run into tab', tabId, 'frame', frameId);
        return;
      }
      log$1.debug('Running scriptlets in the tab', tabId, 'frame', frameId, 'scriptlets', scriptlets);
      const promises = scriptlets.map(scriptlet => BackgroundScript.runScriptlet(tabId, frameId, scriptlet));
      await Promise.all(promises);
      log$1.debug('Finished running scriptlets in the tab', tabId, 'frame', frameId);
    }
    /**
    ...
    static async runScriptlet(tabId, frameId, scriptlet) {
      log$1.debug('Running scriptlet', scriptlet.name, 'in the tab', tabId, 'frame', frameId);
      ...
      log$1.debug('Finished running scriptlet', scriptlet.name, 'in the tab', tabId, 'frame', frameId);
    }
  }
  ...
  const handleMessages = async (request, sender) => {
    ...
    let url = sender.url || '';
    const topUrl = frameId === 0 ? undefined : (_sender$tab2 = sender.tab) === null || _sender$tab2 === void 0 ? void 0 : _sender$tab2.url;
  ...
  const DISABLED_ACTION_ICON = {
    48: "assets/images/icon-disabled-48.png",
    96: "assets/images/icon-disabled-96.png",
    128: "assets/images/icon-disabled-128.png",
    256: "assets/images/icon-disabled-256.png",
    512: "assets/images/icon-disabled-512.png"
  };
  ...
  const actionMessage = (key, fallback) => {
    try {
      const value = browser.i18n && browser.i18n.getMessage ? browser.i18n.getMessage(key) : "";
