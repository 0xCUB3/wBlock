...
- wBlock provides default userscripts including Return YouTube Dislike, Bypass Paywalls Clean, YouTube Classic, AdGuard Extra, tinyShield, and selected site-specific tinyShield scripts. tinyShield is enabled by default on new installs; the others are disabled by default
