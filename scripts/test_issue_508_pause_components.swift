...
check(settings, "Text(\"Paused Components\")", "pause component choices must sit in their own section under Pause Blocking (#604)")
check(!settings.contains(".controlSize(.mini)"), "pause component choices must not be shrunk or indented as sub-controls (#604)")
