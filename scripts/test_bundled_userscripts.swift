...
for needle in [
    ...
    "wblock-tc-content-offset",  // keeps watch content below taller players
    "player-container-id",       // disables the mobile sticky watch player
    "player-placeholder",        // mobile YouTube flow-space reservation
