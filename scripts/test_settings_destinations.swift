...
assertContains(site, "setNoAutoplaySiteAllowed", "Site Settings must retain per-domain autoplay settings")
assertContains(site, "Allow autoplay on this site", "Site Settings must expose per-site autoplay")
assertContains(site, "isAutoplayAllowed", "Site Settings snapshot must include autoplay")
assertNotContains(site, "ZapperRuleManager", "Site Settings must not own zapper data")
assertNotContains(settings, "setNoAutoplaySiteAllowed", "Settings must not own per-site autoplay writes")
