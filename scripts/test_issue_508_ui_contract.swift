...
require(siteSettings, "@State private var pendingUndo: SiteUndoState?")
require(siteSettings, "private func resetSite(_ domain: String)")
...
require(zapper, "ruleManager.deleteRule(rule, forDomain: domain)")
require(zapper, "ruleManager.restoreRule(undo.rule, forDomain: undo.domain, at: undo.index)")
require(zapper, "ruleManager.setDisabled(!enabled, forDomain: domain)")
