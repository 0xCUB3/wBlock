...
var main = (() => {
  ...
  var scriptlets_list_exports = {};
  __export(scriptlets_list_exports, {
...
${stackTrace}`, true);
  ...
  return __toCommonJS(scriptlets_list_exports);
})();
...
;(function(){
  ...
  if (!fn) {
    console.warn("No callable function found for scriptlet module: scriptlets-list");
  }
