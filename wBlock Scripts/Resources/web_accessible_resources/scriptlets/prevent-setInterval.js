...
var main = (() => {
  ...
  // Scriptlets/src/scriptlets/prevent-setInterval.js
  var prevent_setInterval_exports = {};
  __export(prevent_setInterval_exports, {
  ...
  return __toCommonJS(prevent_setInterval_exports);
})();
...
;(function(){
  ...
  if (!fn) {
    console.warn("No callable function found for scriptlet module: prevent-setInterval");
  }
