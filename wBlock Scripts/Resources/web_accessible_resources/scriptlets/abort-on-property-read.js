...
var main = (() => {
  ...
  // Scriptlets/src/scriptlets/abort-on-property-read.js
  var abort_on_property_read_exports = {};
  __export(abort_on_property_read_exports, {
  ...
  return __toCommonJS(abort_on_property_read_exports);
})();
...
;(function(){
  ...
  if (!fn) {
    console.warn("No callable function found for scriptlet module: abort-on-property-read");
  }
