...
var main = (() => {
  ...
  // Scriptlets/src/scriptlets/adjust-setTimeout.js
  var adjust_setTimeout_exports = {};
  __export(adjust_setTimeout_exports, {
  ...
  return __toCommonJS(adjust_setTimeout_exports);
})();
...
;(function(){
  ...
  if (!fn) {
    console.warn("No callable function found for scriptlet module: adjust-setTimeout");
  }
