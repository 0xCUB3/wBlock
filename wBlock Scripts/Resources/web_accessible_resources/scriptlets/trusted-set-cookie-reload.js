...
var main = (() => {
  ...
  // Scriptlets/src/scriptlets/trusted-set-cookie-reload.js
  var trusted_set_cookie_reload_exports = {};
  __export(trusted_set_cookie_reload_exports, {
    trustedSetCookieReload: () => trustedSetCookieReload,
  ...
  return __toCommonJS(trusted_set_cookie_reload_exports);
})();
...
;(function(){
  ...
  if (!fn) {
    console.warn("No callable function found for scriptlet module: trusted-set-cookie-reload");
  }
