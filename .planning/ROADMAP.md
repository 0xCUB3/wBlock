...
- [ ] **Phase 11: Notarization Pipeline** — Resolve `aps-environment`/iCloud entitlements for Developer ID, install provisioning profiles in CI, add observability and validation steps
